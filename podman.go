...
// VllmContainer represents the essential details of a vllm Podman container.
...
func ListVllmContainers() ([]VllmContainer, error) {
	// Define a custom format with a consistent delimiter (e.g., pipe '|')
	// This avoids issues with spaces in fields like COMMAND.
